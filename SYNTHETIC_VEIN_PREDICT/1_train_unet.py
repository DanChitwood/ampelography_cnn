...
from torchvision import transforms # Not directly used for augmentation yet, but good to keep
import os
import pandas as pd
...
import numpy as np
import sys
from tqdm.auto import tqdm # <--- ADDED THIS IMPORT
...
NUM_WORKERS = 0 # Set to 0 for initial stability
MODEL_SAVE_PATH = Path("trained_leaf_segmentation_model.pth") # Path to save the best model
